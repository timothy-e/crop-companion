...
@Database(entities = {Crop.class, Project.class, ProjectCrop.class, HeadCounts.class}, exportSchema = true, version = 1)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract ProjectCropDao cropPlanDao();

    public abstract HeadCountsDao headCountsDao();
